...
> - Simplifies the process of setting the working directory
> - Facilitates collaboration with Git integration
...
> - **GitHub** is a web-based platform that uses Git for version control and provides hosting for software development and version control using Git.

4. What are the two main differences between a tibble and a data.frame?
> - Tibbles do not convert character vectors to factors by default.
> - Tibbles are more modern and have better printing methods that show only the top 10 rows and the columns that fit on the screen.
